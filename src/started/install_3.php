...
<body>
    ...
    <main>
        <article>
            ...
            <p>Preface:</p>
            <p>In this section I need to mention any special quirks that occur when attempting the install on a Windows system vs macOS.</p>
            <p>Take a look at the Git site's Windows download page on their site:<a href="https://git-scm.com/download/windows/" target="_blank">Installing Git on Windows</a></p>
