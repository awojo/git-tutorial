...
<body>
    ...
    <main>
        <article>
            <h2>Installing GitHub Desktop</h2>
	        <p>The site automatically recognizes your operating system and prompts you with the Git software download that you will require.</p>
            <a href="/img/Desktop_Install_GitHub_1.png"><img src="/img/Desktop_Install_GitHub_1.png" alt="GitHub Desktop" class="center-img"></a>
